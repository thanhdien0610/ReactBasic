...
import { getDataAllQuizForAdmin, getDataQuiz, postCreateNewAnswerForQuestion, postCreateNewQuestionForQuiz } from '../../../../services/apiServices';
...
const Questions = (props) => {
    ...
    //     await getDataQuiz(selectedQuiz.value, dispatch);
    //     dispatch(restOptimizeQuiz());
    //     setOptimizeQuiz(store.getState()?.user?.optimizeQuiz);
    // }

    //const data = 
    //console.log('optimize: ', optimizeQuiz);
